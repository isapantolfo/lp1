...
public class Evento {
    ...
    public void criarEvento() {
        ...
        System.out.println("Digite a data inicial do evento, no formato: DD/MM/AAAA");
        String dataievento1= evento1.next();

        System.out.println("Digite a data final do evento, no formato: DD/MM/AAAA");
        String datafevento1= evento1.next();

        System.out.println("Digite o horário inicial do evento, no formato: 00:00");
        String horarioievento1= evento1.next();

        System.out.println("Digite o horário final do evento, no formato: 00:00");
        String horariofevento1= evento1.next();
